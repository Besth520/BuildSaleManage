...
<body>
	<div
		...
		<span style="float: right; margin-top: 35px; color: #488ED5;">房屋销售系统以面向企业的ERP系统为基础，致力于便捷、安全、稳定等方面的客户体验</span>
	</div>
	...
	<div
		...
		<span style="color: #488ED5;">Powered By Besth</span><span
			style="color: #488ED5;margin-left:10px;">推荐浏览器：<a
			href="">Chrome</a>
		</span><span style="float: right; color: #488ED5;">房屋销售BSM系统</span>
	</div>
</body>
</html>