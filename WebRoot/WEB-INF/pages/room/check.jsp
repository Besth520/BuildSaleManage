...
<body class="easyui-layout">
	<div data-options="region:'center'">
		<table class="easyui-datagrid" fit="true" nowrap="false">
			<thead>
				<tr>
					<th data-options="field:'id',width:120,align:'center'">所属房屋</th>
					<th data-options="field:'name',width:120,align:'center'">销售状态</th>
					<th data-options="field:'data',width:520,align:'center'">销售人员</th>
					<th data-options="field:'pick',width:120,align:'center'">审核任务</th>
				</tr>
			</thead>
			<script type="text/javascript">
			...
			<tbody>
				<s:iterator value="list" var="task">
					<tr>
						...
						<td>
							<s:a action="taskAction_%{taskDefinitionKey}" namespace="/" cssClass="easyui-linkbutton">审核任务
